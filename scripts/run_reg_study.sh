...
micromamba run -n "$ENV" python -m src.synthetic_data.training_conv_pyomo --data_type "vdp" --exp "network_size_grid_search" --n_seeds "15" --outdir "results/pyomo_net_size_reg"
