...
# Plotting MAE
plt.figure(figsize=(7, 5))
plt.plot(steps_options, rk4_maes, linestyle='-', color='b', label='RK4 MAE')
plt.plot(steps_options, odeint_maes, linestyle='-', color='g', label='Odeint MAE')
...
# Plotting Computation Time
plt.figure(figsize=(7, 5))
plt.plot(steps_options, rk4_times, linestyle='-', color='orange', label='RK4 Computation Time')
plt.plot(steps_options, odeint_times, linestyle='-', color='r', label='Odeint Computation Time')
